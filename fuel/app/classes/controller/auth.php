...
class Controller_Auth extends Controller_Template
{
	...
	public function action_login()
	{
		...
		if (Input::method() == 'POST')
		{
			...
			{
				Log::error('Login error: ' . $e->getMessage(), __METHOD__);
				Session::set_flash('error', 'ログイン処理中にエラーが発生しました。');
				Response::redirect('report/index');
			}
		}
	...
	public function action_register()
	{
		if (Input::method() == 'POST')
		{
			...
			{
				Log::error('Registration error: ' . $e->getMessage(), __METHOD__);
				Session::set_flash('error', '登録処理中にエラーが発生しました。');
				Response::redirect('report/index');
			}
		}
